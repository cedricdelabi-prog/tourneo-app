  ...
  async function connexionGoogle() {
    ...
    try {
      ...
      if (error) {
        ...
        setMessage("Impossible de se connecter avec Google.");
        setChargement(false);
      }
    } catch (error) {
      console.error("Erreur connexion Google :", error);
      ...
      <section style={s.card}>
        ...
        <div style={s.switcher}>
          ...
          <button
            style={{
              ...s.switch,
              ...(mode === "inscription" ? s.switchActive : {}),
            }}
        ...
        <button
          style={{
            ...s.google,
            ...(chargement ? { opacity: 0.65, cursor: "wait" } : {}),
          }}
        ...
        {mode === "inscription" && (
          <>
            ...
            <label style={s.label}>
              Pseudo Tourneo <span style={s.optional}>facultatif</span>
            </label>
            <input
              style={s.input}
              value={pseudo}
              onChange={(e) => setPseudo(e.target.value)}
              placeholder="Ex. Cedric62"
            />

            <label style={s.label}>
              Ville <span style={s.optional}>facultatif</span>
            </label>
            <input
              style={s.input}
              value={ville}
        ...
        {mode === "connexion" && (
          <button style={s.link} onClick={motDePasseOublie}>
            Mot de passe oublié ?
          </button>
        )}
        ...
        <p style={s.legal}>
          En créant un compte, vous acceptez le fonctionnement et les règles de
          sécurité présentés dans la rubrique Aide & sécurité.
        </p>
      </section>
    </main>
  );
...
const s: Record<string, CSSProperties> = {
  page: {
    ...
    placeItems: "center",
    padding: 18,
    background: "linear-gradient(145deg,#050811,#0B1220)",
    color: "white",
  ...
  primary: {
    ...
    border: 0,
    borderRadius: 14,
    background: "linear-gradient(135deg,#7C5CFF,#3B82F6 55%,#22D3EE)",
    color: "white",
    fontSize: 16,
    fontWeight: 900,
    cursor: "pointer",
